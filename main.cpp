...
//Badan pesawat
{
    glColor3f(0.32, 0.32, 0.32); //Abu-abu
    glPushMatrix();
...
void wingL(){
	//wingLeft
	//glColor3f(0.32, 1.0, 1.0); //Cyan
	//glColor4f(1.0f, 0.5f, 0.0f, 0.0f);//oranye/coklat
	glColor3f(0.0f, 0.5f, 0.5f);//Biru-Hijau
	glPushMatrix();
